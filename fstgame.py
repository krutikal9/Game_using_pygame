...
while True:
    ...
    if game_active:
        ...
        # if bomb_rect.colliderect(player_rect):
            # game_active =False
        # if player_rect.right > bomb_rect.left:
        #     game_active =False

    else :
        print('inside else')
        sc.fill('#90ee90')
        sc.blit(player_stand,player_stand_rect)
        sc.blit(game_name,game_name_rect)
        if score== 0:
            sc.blit(game_msg,game_msg_rect)
        else :
            sc.blit(score_msg,score_msg_rect)
